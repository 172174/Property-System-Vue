...
<!--        &lt;!&ndash; <el-step title="完成评价" :description="formatTime(order.commentTime)"></el-step> &ndash;&gt;-->
<!--      </el-steps>-->
<!--    </div>-->
    <el-card shadow="never" style="margin-top: 15px">
      ...
      <div class="table-layout">
        ...
        <el-row>
          ...
          <el-col :span="6" class="table-cell">{{order.payType  | PayType }}</el-col>
          <el-col :span="6" class="table-cell">{{order.sourceType | formatSourceType }}</el-col>
        </el-row>

        <el-row>
          <el-col :span="6" class="table-cell-title">房屋编号</el-col>
          <el-col :span="6" class="table-cell-title">业主姓名</el-col>
          <el-col :span="6" class="table-cell-title">费用类型</el-col>
